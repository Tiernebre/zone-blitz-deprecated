...
public class Account extends TableImpl<AccountRecord> {
     ...
     */
    public final TableField<AccountRecord, Long> REGISTRATION_ID = createField(DSL.name("registration_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.account.google_account_id</code>.
     */
    public final TableField<AccountRecord, String> GOOGLE_ACCOUNT_ID = createField(DSL.name("google_account_id"), SQLDataType.CLOB, this, "");
    ...
    public List<UniqueKey<AccountRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_REGISTRATION_ID, Keys.UNIQUE_GOOGLE_ACCOUNT_ID);
    }
    ...
    public RegistrationPath registration() {
        if (_registration == null)
            _registration = new RegistrationPath(this, Keys.ACCOUNT__ACCOUNT_REGISTRATION_ID_FKEY, null);
    ...
    public GeneralManagerPath generalManager() {
        if (_generalManager == null)
            _generalManager = new GeneralManagerPath(this, null, Keys.GENERAL_MANAGER__GENERAL_MANAGER_USER_ID_FKEY.getInverseKey());
    ...
    /**
     * Get the implicit to-many join path to the <code>public.league</code>
     * table
     */
    public LeaguePath league() {
        if (_league == null)
            _league = new LeaguePath(this, null, Keys.LEAGUE__LEAGUE_ACCOUNT_ID_FKEY.getInverseKey());
    ...
    public SessionPath session() {
        if (_session == null)
            _session = new SessionPath(this, null, Keys.SESSION__SESSION_ACCOUNT_ID_FKEY.getInverseKey());
