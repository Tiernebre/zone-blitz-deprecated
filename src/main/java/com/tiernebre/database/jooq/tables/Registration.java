...
public class Registration extends TableImpl<RegistrationRecord> {
   ...
   */
  public final TableField<RegistrationRecord, Long> ID = createField(
    DSL.name("id"),
   ...
   */
  public final TableField<RegistrationRecord, String> USERNAME = createField(
    DSL.name("username"),
   ...
   */
  public final TableField<RegistrationRecord, String> PASSWORD = createField(
    DSL.name("password"),
    SQLDataType.CLOB.nullable(false),
    this,
    ""
  ...
  private Registration(
    Name alias,
    Table<RegistrationRecord> aliased,
    Field<?>[] parameters,
    Condition where
  ) {
    super(
  ...
  public <O extends Record> Registration(
    Table<O> path,
    ForeignKey<O, RegistrationRecord> childPath,
    InverseForeignKey<O, RegistrationRecord> parentPath
  ) {
  ...
  public static class RegistrationPath
    ...
    implements Path<RegistrationRecord> {

    private static final long serialVersionUID = 1L;

    public <O extends Record> RegistrationPath(
      Table<O> path,
      ForeignKey<O, RegistrationRecord> childPath,
      InverseForeignKey<O, RegistrationRecord> parentPath
    ) {
  ...
  public AccountPath account() {
    if (_account == null) _account = new AccountPath(
      this,
      null,
      Keys.ACCOUNT__ACCOUNT_REGISTRATION_ID_FKEY.getInverseKey()
    );
