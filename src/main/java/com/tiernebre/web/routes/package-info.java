/**
 * Contains all the specific route and endpoint builders for Zone Blitz.
 *
 * Typically, a "route" in the context of this package is an EndpointGroup
 * that defines the URI and HTTP method pathing.
 *
